...
function App() {
    ...
    function removeTask(id: string, todolistId: number) {
        setTodo(todo.map((m, index) => index === todolistId ? {
            ...m,
            tasks: m.tasks.filter(el => el.taskId !== id)
        } : m))
    ...
    function addTask(title: string, todolistId: number) {
        ...
        setTodo(todo.map((m, index) => index === todolistId ? {...m, tasks: [newTask, ...m.tasks]} : m))
    }
    ...
    function changeStatus(id: string, isDone: boolean, todolistId: number) {
        setTodo(todo.map((m, index) => index === todolistId ? {
            ...m,
            tasks: m.tasks.map(t => t.taskId === id ? {...t, isDone} : t)
        } : m))
